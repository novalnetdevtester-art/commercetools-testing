export const config = {
  ...
  novalnet_GUARANTEED_SEPA_TestMode:
  ...
  novalnet_GUARANTEED_SEPA_PaymentAction:
  ...
  novalnet_GUARANTEED_INVOICE_MinimumAmount:
    process.env.NOVALNET_GUARANTEED_INVOICE_PAYMENT_ACTION_MINIMUM_AMOUNT ||
    "0",
  novalnet_GUARANTEED_SEPA_MinimumAmount:
  ...
  novalnet_GUARANTEED_SEPA_Allowb2bCustomers:
