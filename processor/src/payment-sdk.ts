...
// ✅ Lazy instance
let paymentSDKInstance: ReturnType<typeof setupPaymentSDK> | null = null;

// ✅ Getter (main logic)
export const getPaymentSDK = () => {
  // 👉 Prevent crash during Jest tests
  if (process.env.NODE_ENV === "test") {
    return {} as ReturnType<typeof setupPaymentSDK>;
  }
  ...
  if (!paymentSDKInstance) {
    ...
    paymentSDKInstance = setupPaymentSDK({
...
export const paymentSDK = getPaymentSDK();
