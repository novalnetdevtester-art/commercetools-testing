...
export class Alipay extends BaseComponent {
  ...
  mount(selector: string) {
    ...
    if (!container) {
      console.warn("[Alipay] Container not found:", safeSelector);
      return;
    }
  ...
  async submit() {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        console.error("[Alipay] HTTP error:", {
  ...
  private _getTemplate() {
    ...
    const description =
      locale.startsWith("de")
        ? "Bezahlen Sie bequem mit Alipay und schließen Sie die Zahlung sicher ab."
        : "Pay easily with Alipay and complete your payment securely.";
