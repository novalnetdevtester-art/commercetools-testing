...
export class Eps extends BaseComponent {
  ...
  mount(selector: string) {
    ...
    if (!container) {
      console.warn("[EPS] Container not found:", safeSelector);
      return;
    }
  ...
  private _getTemplate() {
    ...
    const description =
      locale.startsWith("de")
        ? "Bezahlen Sie bequem mit EPS und schließen Sie die Zahlung über Ihre Bank ab."
        : "Pay easily with EPS and complete your payment through your bank.";
